...
## Core features (v1 scope — nothing more, nothing less)
[x] 0. Skeleton app with empty window
[] 1. Input can be a YouTube URL. Example, to use for testing: https://www.youtube.com/watch?v=siCmqvfw_1g (this is No Copyright Music free to use or modify).
